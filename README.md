...
<p>
Huawei Ads ve AppsFlayer panellerinin birbirleriyle iletişim halinde olabilmeleri için panel tarafında birkaç entegrasyon işlemi yapılması gerekmektedir. Öncelikle AppsFlyer panelde Click ve Impression URL’lerinin oluşturulması gerekmektedir. Bunun için; <br>
</p>
...
<p>
 Tool provider kısmında AppsFlayer, App kısmında ise uygulamanız seçilmelidir.
 </p>
...
<p>
- Appsflayer panelde Install verisi neden gözükmüyor?
...
<p>
- Appsflayer panelde neden Revenue kısmını göremiyorum?
